...
;Receives: ESI points the array, ECX = array size
;Returns: nothing
;-----------------------------------------------------
	mov edx,OFFSET str1									;"Enter a signed integer"
L1:
	call WriteString									;display string "Enter a signed integer :"
	call ReadInt										;read integer into EAX
	call Crlf											;go to the next output line
...
L1:
	...
	add esi,TYPE DWORD									;points to next integer
